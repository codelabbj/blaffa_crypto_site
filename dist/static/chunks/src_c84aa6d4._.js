...
function CryptoTransactionForm({ isVerified, crypto, typeTrans }) {
    ...
    const [amount, setAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // For buy: local currency, for sell: crypto amount
    const [calculatedValue, setCalculatedValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // For buy: crypto, for sell: local currency
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showHashModal && transactionType === 'sale' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Modal, {
...
_s(CryptoTransactionForm, "UboVuC8CXOumJ8jiM8n+w4JCW50=", false, function() {
    return [
...
function CryptoPage() {
        ...
        "CryptoPage.useEffect": ()=>{
            ...
            const fetchCryptos = {
                "CryptoPage.useEffect.fetchCryptos": async ()=>{
                    ...
                    try {
                        const token = localStorage.getItem("accessToken");
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(CRYPTO_API + `?type_trans=${typeTrans}`, {
                            headers: {
                                "Content-Type": "application/json",
                                ...token ? {
                                    Authorization: `Bearer ${token}`
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CryptoPage.useEffect": ()=>{
            ...
            let isMounted = true;
            const checkStatus = {
                "CryptoPage.useEffect.checkStatus": async ()=>{
            ...
            }["CryptoPage.useEffect.checkStatus"];
            checkStatus();
            return ({
                "CryptoPage.useEffect": ()=>{
                    isMounted = false;
